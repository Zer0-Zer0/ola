...
if (isset($entrar)) {
    ...
    if (strlen($acesso) == 11) {
        ...
        if ($resultado && $resultado->num_rows == 1) {
            ...
            $cores = "Coordenacao de Registro (CORES)";
            $ed = "Coordenacao de Curso de Edificacoes";
            $ema = "Coordenacao de Curso de Meio Ambiente";
            $ei = "Coordenacao de Curso de Informatica";
